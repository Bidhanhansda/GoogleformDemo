                ...
                <tbody>
                    {
                        props.data.rows.map((item, idx) => (
                            <tr className=" bg-gray-100 mb-3 border-b-4 border-white "  key={idx}>
                                ...
                                <input  type="radio" name={`${item} `} value={item} className="w-8 h-8 border-4 focus:accent-form-top accent-form-top bg-gray-100  cursor-pointer " onClick={(e)=>setResponse(e.target.value)} required/>
